...
namespace Foundation.Campaign
{
    ...
    public class PostClickInterceptor : ITrackingDataInterceptor
    {
        ...
        private const string _trackEventBasket = "basket";
        private const string _trackEventCategory = "category";
        private const string _trackEventOrder = "order";
        private const string _trackEventProduct = "product";
        private const string _trackEventPageView = "epiPageView";
